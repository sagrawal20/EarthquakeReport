...
//
                earthquakes.add(new Data(magnitude, place, time, url));
                Data data = new Data(magnitude, place, time, url);
            }
